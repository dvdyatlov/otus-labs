...
## смотрим что получилось, и вопросы
...
Наверняка это рассказывалось на лекциях, видимо я просто пропустил - подскажите пожалуйста, правильно ли я понял:

**как только на бордер-лифах 2 и 3 мы создаем ipv4-соседство к бродер-роутеру, устройство сразу, без дополнительных настроек, все роуты, которые прилетели в него в af evpn (из остальной фабрики), начинает транслировать/редистрибутить в af ipv4, и раздавать соответственно в сторону ip-нейборов. ну и наоборот (в виде type-5)**

вот например на leaf-2 (мы не говорили пока никаких редистрибьютов вообще) мы видим два роута, возникшие из bgp evpn:
```
